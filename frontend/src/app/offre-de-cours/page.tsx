    ...
    const detailedOffers = [
        {
            ...
            description: "Cours individuels de français ludiques et adaptés aux enfants de 6 à 12 ans. Méthodes pédagogiques personnalisées pour captiver l'attention de votre enfant.",
            price: "35€",
            duration: "par mois",
        ...
        },
        {
            ...
            description: "Cours individuels adaptés aux adolescents de 13 à 17 ans. Focus personnel sur l'expression orale et écrite avec des sujets qui passionnent votre adolescent.",
            price: "45€",
            duration: "par mois",
        ...
        },
        {
            ...
            description: "Cours individuels sur-mesure pour adultes tous niveaux. Apprentissage flexible et exclusif adapté à votre rythme de vie et vos objectifs professionnels.",
            price: "55€",
            duration: "par mois",
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {detailedOffers.map((offer, index) => (
                            <div 
                                key={offer.title}
                                className={`scroll-animate-scale scroll-animate-delay-${index + 1} ${offersSection.isVisible ? 'visible' : ''}`}
                            >
                                <div className={`relative bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 ${offer.popular ? 'ring-2 ring-red-500' : ''}`}>
                                    {offer.popular && (
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">8 années d&apos;expérience avec plus de 1500 élèves satisfaits</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">Attention exclusive du professeur pour un apprentissage optimal</p>
                                    </div>
                                </div>
                        ...
                        <div className="relative">
                            <div className="bg-gradient-to-br from-red-500 to-orange-600 rounded-2xl p-8 text-white">
                                ...
                                <p className="mb-6">
                                    Découvrez notre approche pédagogique personnalisée avec des cours individuels adaptés à votre niveau et vos objectifs.
                                </p>
