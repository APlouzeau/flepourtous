        ...
        <div className="min-h-screen bg-gray-100">
            ...
            <div className="lg:hidden min-h-screen relative">
                ...
                <div className="absolute inset-0 z-0">
                    <Image src="/images/House.jpg" alt="Maison FLE Pour Tous" fill className="object-cover" priority />
                ...
                <div className="relative z-10 flex flex-col min-h-screen">
                    ...
                    <div className="flex justify-start p-4 sm:p-6">
                        ...
                        >
                            ...
                            <span className="text-sm sm:text-base font-medium">{trad("profile.auth.return")}</span>
                        </Link>
                    </div>
                    ...
                    <div className="w-full max-w-7xl relative">
                        ...
                        <div className="mb-6">
                            ...
                            >
                                ...
                                <span className="font-medium">{trad("profile.auth.returnToHome")}</span>
                            </Link>
                        </div>
                        ...
                        <div className="grid lg:grid-cols-3 xl:grid-cols-5 gap-0 rounded-[3rem] overflow-hidden shadow-2xl bg-white border border-gray-200">
                            ...
                            <div className="lg:col-span-1 xl:col-span-2 flex items-center justify-center bg-white">
