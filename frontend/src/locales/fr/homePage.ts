export default {
    homePage: {
            ...
            features: [
                ...
                },
                {
                    transparentPricing: {
                        ...
                        description:
                            "Vous connaissez le prix dès le départ : que vous preniez un cours à l’unité ou un forfait, tout est clairement indiqué. Le rapport qualité-prix est pensé pour que chacun puisse progresser à son rythme, sans se ruiner.",
                    },
                },
                {
                    personalizedApproach: {
                        ...
                        description:
                            "Chaque leçon est conçue en fonction de votre niveau, de vos objectifs (voyage, travail, examen…) et de vos centres d’intérêt. J’écoute vos besoins et j’adapte le contenu pour que l’apprentissage soit vivant, efficace et motivant.",
                    },
                },
            ],
        },
        PricesSection: {
            ...
            span: "formules",
            description:
                "Choisissez le cours qui vous convient le mieux suivant vos objectifs et la durée que vous préférez.",
        },
        numbersSection: {
            stats: {
        ...
        testimonial: {
            ...
            graham: {
                ...
                nationality: "Anglais",
                comment:
                    "Je dois dire qu’au moment de m’inscrire, j’étais terrifié à l’idée de devoir vraiment parler français. Ludivine est incroyable, elle sait mettre à l’aise immédiatement. J’apprends à parler français en tant que grand débutant, et elle est la personne la plus patiente du monde. Elle supporte mon accent affreux et ma grammaire approximative, et me corrige toujours avec douceur. Elle a un don pour faire couler le français naturellement. Elle parle lentement et clairement. Elle est vraiment formidable. merci Ludivine tu es très gentille et tu es un excellent professeur.",
            },
        },
        faqSection: {
        ...
        CtaSection: {
            ...
            description:
                "Chaque journée est une occasion de progresser. Investissez dans votre avenir dès aujourd'hui avec FLEpourtous. L'excellence en français n'attend pas – elle se construit maintenant, un cours après l'autre.",
        },
    },
} as const;
